...
function webEnvironment(channel, databaseUrl) {
  ...
  return {
    ...
    EMAIL_PROVIDER: isTest ? "disabled" : "resend",
    REGISTRATION_ENABLED: isTest ? "false" : "true",
    RESEND_API_KEY: isTest ? "" : "runtime-smoke-resend-key",
    RESEND_FROM: "runtime-smoke@example.com",
...
async function main() {
  ...
  const seedEnvironment = {
    ...
    LOCAL_EMAIL_EVIDENCE_ENABLED: "true",
