export const SCANNER_AUTH_LINK_TTL_SECONDS = 60 * 60;

export type ScannerAuthEmailPurpose = "registration" | "recovery";

type ScannerAuthEmail = Readonly<{
  subject: string;
  text: string;
  html: string;
}>;
...
const copy = {
  ...
  recovery: {
    ...
    body: "Use this secure link to recover access to your private Agentify report.",
    action: "Recover report access",
  },
} as const;

export function scannerAuthEmail(
  purpose: ScannerAuthEmailPurpose,
  url: string,
): ScannerAuthEmail {
