...
export function getServerConfig() {
  ...
  const hmacSecret =
    parsed.TOKEN_HMAC_SECRET ?? "local-development-hmac-secret-change-before-production";
  ...
  if (encryptionKey.length !== 32) throw new Error("email_encryption_key_must_be_32_bytes_base64");
