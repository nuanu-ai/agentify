...
export default withMermaid(
  defineConfig({
    ...
    head: [
      ...
      [
        "meta",
        {
          ...
          content:
            "Connect your shop, publish product cards and fulfil paid orders from AI agents.",
        },
      ],
    ...
    transformHtml(code) {
      ...
      return marked.replace(/[ \t]*<link rel="modulepreload" href="([^"]+)">\n?/g, (link, href) =>
        KEPT_CHUNK.test(href) ? link : "",
      );
    },
  }),
);
