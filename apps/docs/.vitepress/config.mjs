...
const SURFACE_MARKER = [
  ...
  '<p class="surface-words">Test environment. Payments settle on Base Sepolia with test funds, and every order and receipt here is marked as a test. The live site is commerce.agentify.ad.</p>',
