...
once, and on the live channel you are sent a message about it too, so a
wallet somebody else set is not news you find on a screen. On the test channel
every change applies at once and nothing is sent.
