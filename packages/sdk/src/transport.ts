 ...
 * `@nuanu-ai/agentify-contracts`. No path is written down in this package, and the
 ...
 * and the scheme live in `@nuanu-ai/agentify-contracts`, in the one place both sides
